...
class WotPlayerTankStatistic extends CActiveRecord
{

	/**
	 * Returns the static model of the specified AR class.
	 * @return WotPlayerTankStatistic the static model class
	 */
	...
	{
		return 'wot_player_tank_statistic';
	}
	...
	public function relations()
	{
		...
		return array(
			'playerTank'=>array(self::BELONGS_TO, 'WotPlayerTank', 'player_id,tank_id'),
