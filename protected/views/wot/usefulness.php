...
$options=CJavaScript::encode(array(
		...
		'colNames'=>array('Игрок', 'Проц. побед', 'Кол-во топов', '300 боев', 'Ivanerr'),
		'colModel'=>array(
		...
		//	array('name'=>'updated_at','index'=>'updated_at','width'=>110,'align'=>'right','sorttype'=>'date','firstsortorder'=>'desc','formatter'=>'date','formatoptions'=>array('srcformat'=>'Y-m-d H:i:s','newformat'=>'d.m.Y H:i')),
			...
			array('name'=>'ivanerr','index'=>'ivanerr','width'=>80,'align'=>'right','formatter'=>'number','sorttype'=>'number','firstsortorder'=>'desc'),
		),
		'rowNum'=>1000,
